          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="font-display text-5xl lg:text-6xl font-bold">
                Audit Transformateurs <GradientText>HT/MT/BT</GradientText> <GradientText>Optimisation</GradientText>
              </h1>
            </div>
            <p className="text-xl text-white/70 max-w-3xl">
              Analyse approfondie et amélioration de la performance de vos réseaux électriques
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            <GlassCard className="p-6">
              <h3 className="font-display text-xl font-bold mb-4">Types d'Audits</h3>
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start gap-2">
                  <FaCheckCircle className="text-cyber-blue mt-1 flex-shrink-0" />
                  <span>Étude de pertes électriques</span>
                </li>
                <li className="flex items-start gap-2">
                  <FaCheckCircle className="text-cyber-blue mt-1 flex-shrink-0" />
                  <span>Plan d'optimisation</span>
                </li>
                <li className="flex items-start gap-2">
                  <FaCheckCircle className="text-cyber-blue mt-1 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <FaCheckCircle className="text-cyber-blue mt-1 flex-shrink-0" />
                  <span>ROI et business case</span>
                </li>
              </ul>
            </GlassCard>

            <GlassCard className="p-6">
              <h3 className="font-display text-xl font-bold mb-4">Bénéfices</h3>
              <ul className="space-y-2 text-sm text-white/70">
                <li>• Réduction des pertes techniques</li>
                <li>• Économies d'énergie mesurables</li>
                <li>• Amélioration de la qualité</li>
                <li>• Identification des anomalies</li>
                <li>• Planification investissements</li>
              </ul>
            </GlassCard>
          </div>
